...
#define IN_CODE_TABLE {\
	...
	IN::F,	IN::F, IN::F, IN::F, IN::F,	IN::F, IN::F, IN::F, IN::T,	IN::T, IN::T, IN::T, IN::F,	IN::T, IN::F, IN::F,\
	IN::T,	IN::F, IN::F, IN::T, IN::T,	IN::T, IN::F, IN::T, IN::T,	IN::T, IN::T, IN::T, IN::T,	IN::T, IN::F, IN::T,\
